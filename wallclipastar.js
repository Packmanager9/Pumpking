...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    (function(definition) {
      ...
      if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        window.liarsastar = exports.liarsastar;
    ...
    var liarsastar = {
      ...
      *          astar.heuristics).
      */
      search: function(graph, start, end, options, agent) {
        //   ////////console.log(graph)
        graph.cleanLiar();
        options = options || {};
        ...
        while (openHeap.size() > 0) {
          ...
          for (var i = 0, il = neighbors.length; i < il; ++i) {
            ...
            if (neighbor.closed ||  neighbor.occupied == true) { //neighbor.closed ?
    ...
    Graph.prototype.init = function() {
      ...
      for (var i = 0; i < this.nodes.length; i++) {
        liarsastar.cleanNode(this.nodes[i]);
      }
    };
